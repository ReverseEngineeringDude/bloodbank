...
function filterDonors() {
  ...
  const filtered = allDonors.filter(donor => {
    const matchBloodGroup = !bloodGroup || donor.bloodGroup === bloodGroup;
    const matchLocation = !location || donor.location === location;
    const matchAvailability = !availability || donor.availability === availability;
    return matchBloodGroup && matchLocation && matchAvailability;
  });
